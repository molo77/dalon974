// Scraper Leboncoin simplifié avec ProtonVPN manuel
// L'utilisateur se connecte manuellement à ProtonVPN
...
async function scrapeWithProtonSimple() {
  console.log('🔧 Démarrage du scraper Leboncoin avec ProtonVPN manuel...\n');
  
  console.log('📋 Informations importantes:');
  console.log('🔄 Le script détectera automatiquement les blocages');
  console.log('🌐 Vous devrez vous connecter manuellement à ProtonVPN');
