        ...
        <div className="bg-white/80 backdrop-blur-sm py-10 px-6 shadow-2xl sm:rounded-2xl sm:px-10 border border-white/20">
          ...
          <div className="mt-8">
            ...
            <div className="mt-6">
              <button
                ...
                disabled={loading}
                className="w-full inline-flex justify-center items-center py-3 px-4 border border-gray-300 rounded-xl shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-500 transition-all duration-200 transform hover:scale-[1.02] disabled:opacity-50"
              >
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link href="/signup" className="font-semibold text-purple-600 hover:text-purple-500 transition-colors duration-200">
                Créer un compte
              </Link>
            </p>
          </div>
