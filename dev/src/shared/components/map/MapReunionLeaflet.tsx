  ...
  return (
    <div className={className} style={{ width: '100%', position: 'relative', zIndex: 0 }}>
      <div className="flex flex-wrap items-center gap-3 mb-4">
        <button
          type="button"
          className="group inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-sky-50 to-cyan-50 border border-sky-200 text-sky-700 rounded-xl hover:from-sky-100 hover:to-cyan-100 hover:border-sky-300 hover:shadow-md transition-all duration-200 text-sm font-medium animate-pulse-slow"
