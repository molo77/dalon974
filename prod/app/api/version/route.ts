  ...
  try {
    ...
    function getPackageVersion(): string {
      try {
        ...
        console.log('[API][version] Version trouvée:', packageData.version);
        return packageData.version || '0.2.0';
      } catch (error) {
        console.error('[API][version] Erreur lecture package.json:', error);
        return '0.2.0';
      }
    }
    ...
    console.error('[API][version] Erreur:', error);
